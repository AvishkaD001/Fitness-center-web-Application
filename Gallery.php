...
<header id="main">
  ...
  <div class="header1">
   ...
   <div class="fullimg" id="fullimgbox">
     ...
     <span onclick="closefullimg()"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></span>
   </div>
          ...
          <img src="img/Gallery/10.jpg" onclick="openfullimg(this.src)">
          <img src="img/Gallery/11.jpg" onclick="openfullimg(this.src)">
          <img src="img/Gallery/12.jpg" onclick="openfullimg(this.src)">
        </div>
